...
export class UnefaNav extends Component {
        ...
        if (this.state.isCoordinator) {
            sections.push({
                ...
                items: [
                    ...
                    { action: "action_temp_block_manager", label: "Bloques Temporales", icon: "fa-qrcode" },
                    { action: "action_justification_manager", label: "Justificaciones", icon: "fa-gavel" },
                    { action: "action_calendar_manager", label: "Calendario Institucional", icon: "fa-calendar-o" },
                    { action: "action_attendance_analysis", label: "Análisis", icon: "fa-bar-chart", isOwl: true },
                    { action: "action_report_generator", label: "Reportes", icon: "fa-table" },
                    { action: "action_executed_hours", label: "Horas Ejecutadas", icon: "fa-hourglass-half", isOwl: true },
    ...
    navigateTo(item) {
        ...
        const NEEDS_MODULE_PREFIX = new Set([
            ...
            'action_report_generator',
            'action_executed_hours',
            'action_justification_manager',
            'action_temp_block_manager',
